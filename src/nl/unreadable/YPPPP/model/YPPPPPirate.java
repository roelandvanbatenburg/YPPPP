...
public class YPPPPPirate {
	...
	public void setSF(int v) {
		SF = v;
	}

	public void setBilge(int v) {
		Bilge = v;
	}

	public void setSailing(int v) {
		Sailing = v;
	}

	public void setRigging(int v) {
		Rigging = v;
	}

	public void setDNav(int v) {
		DNav = v;
	}

	public void setBNav(int v) {
		BNav = v;
	}

	public void setGunning(int v) {
		Gunning = v;
	}
	...
	public void setTH(int v) {
		TH = v;
	}

	public void setForage(int v) {
		Forage = v;
	}
